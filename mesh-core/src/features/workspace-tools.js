...
export class WorkspaceTools {
     ...
     */
    listFiles(dirPath, recursive = false, maxDepth = 3) {
    ...
    walkDirectory(dir, listing, maxDepth, currentDepth, relativePath) {
     ...
     * Write file content
     */
    writeFile(filePath, content, createDirs = true) {
        const fullPath = this.resolveWorkspacePath(filePath);
     ...
     * Get git diff
     */
    gitDiff(base = "HEAD", head = "working") {
        try {
